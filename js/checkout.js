...
let bank="970422";
let account="10101112004";
let name="MIN FOOD";

let qr=`https://img.vietqr.io/image/${bank}-${account}-compact2.png?amount=${total}&addInfo=${orderId}&accountName=${name}`;

document.getElementById("qr-payment-img").src = qr;

alert("Mã đơn hàng của bạn: " + orderId);
