...
function createDiscountCodes() {
    if (localStorage.getItem('discountCodes') == null) {
        const codes = [
            // Thêm trường 'min_items': số lượng sản phẩm tối thiểu
            { name: 'SUMMER20', value: 20, type: 'percent', expiry: '2025-08-31', min_items: 2 }, 
            { name: 'FREE30K', value: 30000, type: 'fixed', expiry: '2025-12-31', min_items: 1 },
        ];
